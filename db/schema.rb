...
ActiveRecord::Schema[7.1].define(version: 2025_11_04_150000) do
  ...
  create_table "kanban_columns", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "user_id", "board_type"], name: "index_kanban_columns_on_account_user_board"
    t.index ["position"], name: "index_kanban_columns_on_position"
  end
