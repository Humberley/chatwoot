class Api::V1::Accounts::ContactsController < Api::V1::Accounts::BaseController
  ...
  before_action :fetch_contact, only: [:show, :update, :destroy, :avatar, :contactable_inboxes, :destroy_custom_attributes, :update_kanban_position]
  ...
  def update_kanban_position
    @contact.custom_attributes = @contact.custom_attributes.merge(
      'kanban_column_id' => params[:column_id]&.to_s,
      'kanban_position' => params[:position]&.to_i
    )
    @contact.save!
    head :ok
  end
